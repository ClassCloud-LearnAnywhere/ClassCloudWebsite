...
1. Clone this repository:
   ```bash
   git clone https://github.com/ClassCloud-LearnAnywhere/ClassCloudWebsite.git
   cd ClassCloudWebsite
   ```
...
├── assets/
│   ├── ClassCloud(LONG).svg    # Logo
│   ├── dashboard-preview.png   # Screenshots (add these)
│   ├── student-dashboard-demo.png
│   ├── admin-dashboard-demo.png
│   ├── avery-hughes.jpg        # Team photos (add these)
│   └── martin-topp.jpg
└── README.md
```
